...
context('Cadastro', () => {
    it('Cadastro de usuário no site', () => {
        ...
        cy.get('input#imagesrc').attachFile('foto.jpeg');  //vai anexar a foto
        ...
        cy.url('').should('contain','WebTable'); //verifica que está na URL esperada, pois trocou de tela e URL qd fez o cadastro
    });
});
